...
set short_term_archiving_root_dir = default #       ""                                              ""
...
#short_term_archiving_root_dir:  The directory to put short-term archived data in (if do_short_term_archiving=true). If set to 
...
#=======================================================
# SET RUN_ROOT_DIR AND SHORT_TERM_ARCHIVING LOCATIONS: 
#=======================================================
...
if ( `lowercase $short_term_archiving_root_dir` == 'default' ) then
  if ( $machine == 'edison' || $machine == 'hopper' ) then
...
./xmlchange -file env_run.xml -id DOUT_S_ROOT -val $short_term_archiving_root_dir
