...
# that should be setup here (before case_scripts.build because it checks the necessary 
# files exist)
...
# set input_data_dir = '/lustre/atlas/proj-shared/cli112/pjcs/ACME_inputdata'    # PJC-OLCF
  set input_data_dir = '/lustre/atlas/proj-shared/cli112/golaz/ACME_inputdata'   # Golaz-OLCF
endif

if ( $?input_data_dir && -d  $input_data_dir ) then
...
### For coupled simulations, patch MPAS-O and MPAS-CICE streams for monthly output ###
if ( $compset =~ "A_B*" ) then

  echo
  echo 'Attempting to patch MPAS-O and MPAS-CICE streams for monthly output' 
  pushd ../run
